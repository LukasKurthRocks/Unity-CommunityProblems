...
class HierarchyIcons {
    ...
    {
        { "PrefabAnchor", "Assets/Plugins/CustomHierarchy/WindowIcons/Anchor.png"},
        { "Joint", "Assets/Plugins/CustomHierarchy/WindowIcons/Joint.png"},
        { "ModelBuilderPrefab", "Assets/Plugins/CustomHierarchy/WindowIcons/Prefab.png"}
    };
    ...
    static HierarchyIcons() {
        ...
        normalChildSprite = AssetDatabase.LoadAssetAtPath("Assets/Plugins/CustomHierarchy/WindowIcons/HierarchyIcons/Child_Normal.png", typeof(Texture2D)) as Texture2D;
        lastChildSprite = AssetDatabase.LoadAssetAtPath("Assets/Plugins/CustomHierarchy/WindowIcons/HierarchyIcons/LastChild_Normal.png", typeof(Texture2D)) as Texture2D;
        parentConnection = AssetDatabase.LoadAssetAtPath("Assets/Plugins/CustomHierarchy/WindowIcons/HierarchyIcons/ParentConnection_Normal.png", typeof(Texture2D)) as Texture2D;

        normalChildSpriteHighlighted = AssetDatabase.LoadAssetAtPath("Assets/Plugins/CustomHierarchy/WindowIcons/HierarchyIcons/Child_Highlight_Dark.png", typeof(Texture2D)) as Texture2D;
        lastChildSpriteHighlighted = AssetDatabase.LoadAssetAtPath("Assets/Plugins/CustomHierarchy/WindowIcons/HierarchyIcons/LastChild_Highlight_Dark.png", typeof(Texture2D)) as Texture2D;
        parentConnectionHighlighted = AssetDatabase.LoadAssetAtPath("Assets/Plugins/CustomHierarchy/WindowIcons/HierarchyIcons/ParentConnection_Highlight_Dark.png", typeof(Texture2D)) as Texture2D;
